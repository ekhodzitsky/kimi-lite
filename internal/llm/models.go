...
var registry = map[string]modelConfig{
	...
	"moonshot-v1-8k":   {provider: "moonshot", maxTokens: 4096, contextWindow: 8192},
	"moonshot-v1-32k":  {provider: "moonshot", maxTokens: 4096, contextWindow: 32768},
	"moonshot-v1-128k": {provider: "moonshot", maxTokens: 4096, contextWindow: 131072},

	// OpenAI models
	"gpt-4o":        {provider: "openai", maxTokens: 4096, contextWindow: 128000},
	"gpt-4o-mini":   {provider: "openai", maxTokens: 4096, contextWindow: 128000},
	"gpt-4-turbo":   {provider: "openai", maxTokens: 4096, contextWindow: 128000},
	"gpt-4":         {provider: "openai", maxTokens: 4096, contextWindow: 8192},
	"gpt-3.5-turbo": {provider: "openai", maxTokens: 4096, contextWindow: 16385},
}

// modelInfo converts internal modelConfig to api.ModelInfo.
func modelInfo(name string, m modelConfig) api.ModelInfo {
